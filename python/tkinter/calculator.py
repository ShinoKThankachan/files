...
#     b=e2.get()
#     c=a+b
#     l1=tkinter.Label(text=c)
#     l1.place(y=120)
# def sub():
#     a=e1.get()
#     b=e2.get()
#     c=a-b
#     l2=tkinter.Label(text=c)
#     l2.place()
# def mul():
#     a=e1.get()
#     b=e2.get()
#     c=a*b
#     l3=tkinter.Label(text=c)
#     l3.pack()
# def div():
#     a=e1.get()
#     b=e2.get()
#     c=a/b
#     l4=tkinter.Label(text=c)
#     l4.pack()
...
# e1.pack()
# e2=tkinter.Entry(win,background="white", foreground="black")
# e2.pack()
# b1=tkinter.Button(win,text="+",background='yellow',foreground='black',padx=2,pady=2,command=add)
# b1.place(x=100,y=50)
# b2=tkinter.Button(win,text="-",background='yellow',foreground='black',padx=2,pady=2,command=sub)
# b2.place(x=120,y=50)
# b3=tkinter.Button(win,text="*",background='yellow',foreground='black',padx=2,pady=2,command=mul)
# b3.place(x=100,y=90)
# b4=tkinter.Button(win,text="/",background='yellow',foreground='black',padx=2,pady=2,command=div)
# b4.place(x=120,y=90)
# win.mainloop()
